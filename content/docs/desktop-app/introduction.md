+++
description = "Learn how to Paddler's local AI cluster via a desktop application."
...
## The desktop app is still in beta :)

<Note>
    Paddler's desktop application is still in beta. Things mostly work, but you may run into bugs or rough edges as we keep improving it.
    
    If you have feedback, want to contribute, or have ideas for what we should build next, we'd love to hear from you. Feel free to open an issue, send  PR, or reach out to us in any other way on our [GitHub repository](https://github.com/intentee/paddler).
</Note>
