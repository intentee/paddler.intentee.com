...
2. Clone our [repository](https://github.com/intentee/paddler) then build the desktop app from the project root. On macOS and Linux you can use the `make target/release/paddler_gui` command to build the binary.
