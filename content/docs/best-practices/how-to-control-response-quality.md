...
When your application needs the response in a strict format, like a JSON, an enum value, or a custom format, you can attach a grammar to the request. See [Using grammars](docs/starting-out/using-grammars) for more details.
